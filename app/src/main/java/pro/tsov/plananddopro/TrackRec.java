...
public class TrackRec {
    ...
    public String getTabbedText(PlanDoDBOpenHelper helper){
        ...
        String Result = "Plan and Do Pro (event track)\nhttps://play.google.com/store/apps/details?id=pro.tsov.plananddopro"+ev.getTabbedText(eventId)+"\n\n"+"Date\tStatus\tComment";
        ...
        for (int i = 0; i < keys.size(); i++) {
            ...
            if (et == 2) ets = "do";
            if (et == 3) ets = "cancel";
            Result = Result+ iso8601Format.format(dt)+"\t"+ets+"\t"+trackcomments.get(dt)+"\n";
        }
